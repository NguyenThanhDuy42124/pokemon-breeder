...
const translations = {
  en: {
    ...
    sampleBuildNoMatchHint: "No sample build for this Pokemon in the selected generation/format.",
  ...
  vi: {
    ...
    sampleBuildNoMatchHint: "Pokémon này chưa có build mẫu trong thế hệ/format đã chọn.",
